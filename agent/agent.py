...
from .prompts import assemble_system_prompt, get_user_prompt, extract_sql
...
def generate_sql(state: AgentState) -> AgentState:
    ...
    Uses ChatOpenAI with GPT-4o (or configured model).
...
def run_agent(question: str) -> AgentState:
    """Run the NL2SQL agent on a question.
